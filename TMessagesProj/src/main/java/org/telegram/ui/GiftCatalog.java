...
public final class GiftCatalog {
    /** 300,001 local gift slots; the catalog is generated from the base gift set. */
    public static final int COUNT = 300001;
    ...
    public static String name(int id) {
        int safe = Math.max(1, id);
        int index = (safe - 1) % NAMES.length;
        int series = (safe - 1) / NAMES.length;
        return series == 0 ? NAMES[index] : NAMES[index] + " #" + safe;
    }
